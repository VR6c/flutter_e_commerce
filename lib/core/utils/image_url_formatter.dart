/// Formatter and fallback provider for image URLs.
///
/// Vercel serverless deployments do not persist or serve local `/storage/...` assets
/// without cloud storage (S3/Cloudinary), causing 404 errors. This formatter provides
/// curated, high-quality images matching products, banners, and categories when storage
/// URLs are unresolvable.
const Map<String, String> _knownProductImages = {
  ...
  'red-bell-pepper': 'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=600&q=80',
  ...
  'fresh-potato': 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&q=80',
  'fresh-cabbage': 'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=600&q=80',
  ...
  'red-tomato': 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&q=80',
  'fresh-orange': 'https://images.unsplash.com/photo-1547514701-42782101795e?w=600&q=80',
  'orange': 'https://images.unsplash.com/photo-1547514701-42782101795e?w=600&q=80',
  'fresh-apple': 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=600&q=80',
  'apple': 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=600&q=80',
  'bundle-pack': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80',
  'popular-pack': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80',
  'grocery-pack': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80',
  'avocado': 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=600&q=80',

  // Fashion - Outerwear & Tops
  'puffer-winter-coat': 'https://images.unsplash.com/photo-1544441893-675973e31985?w=600&q=80',
  'quilted-vest': 'https://images.unsplash.com/photo-1516257984-b1b4d707412e?w=600&q=80',
  'denim-jacket': 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=600&q=80',
  'bomber-jacket': 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=600&q=80',
  'hooded-zip-up-sweatshirt': 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=600&q=80',
  'henley-button-tee': 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=600&q=80',
  'business-slim-fit-shirt': 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=600&q=80',
  'tie-dye-boho-tee': 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=600&q=80',
  'linen-blend-summer-shirt': 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&q=80',
  'performance-dry-fit-tee': 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=600&q=80',

  // Fashion - Bottoms
  'workout-leggings': 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=600&q=80',
  'sport-running-shorts': 'https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=600&q=80',
  'high-rise-skinny-jeans': 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=600&q=80',
  'slim-chino-pants': 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=600&q=80',

  // Shoes & Accessories
  'woven-leather-sandals': 'https://images.unsplash.com/photo-1603808033192-082d6919d3e1?w=600&q=80',
  'leather-oxford-shoes': 'https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=600&q=80',
  'canvas-sneakers': 'https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=600&q=80',
  'canvas-tote-bag': 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&q=80',
  'knit-beanie-hat': 'https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=600&q=80',
  'leather-belt-classic': 'https://images.unsplash.com/photo-1624222247344-550fb60583dc?w=600&q=80',
};

const Map<String, String> _knownBannerImages = {
  'daily groceries': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80',
  'groceries': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80',
  'shoes-ready': 'https://images.unsplash.com/photo-1552346154-21d32810aba3?w=800&q=80',
  'ready to shop': 'https://images.unsplash.com/photo-1552346154-21d32810aba3?w=800&q=80',
  'cat1-removebg-preview': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80',
  'new arrivals': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80',
  'cat7-removebg-preview': 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80',
  'summer sale': 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80',
  '07-300x300': 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&q=80',
  'top electronics': 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&q=80',
};
...
const Map<String, String> _knownCategoryImages = {
  ...
  'smartphones-mobile': 'https://images.unsplash.com/photo-1598327105854-e4ee1e4f2b17?w=400&q=80',

  // Fashion & Apparel
  'fashion': 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=400&q=80',
  'fashion-apparel': 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=400&q=80',
  't-shirts': 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80',

  // Footwear & Shoes
  'footwear-shoes': 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&q=80',
  ...
  'sports': 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=400&q=80',
  'outdoors': 'https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=400&q=80',

  // Accessories & Jewelry
  'accessories-jewelry': 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&q=80',
  ...
  // Home & Beauty
  'home-kitchen': 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?w=400&q=80',
  'health-beauty': 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&q=80',
  ...
  'bundle': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=400&q=80',
...
String getFallbackImageUrl({
  ...
  if (isCategory) {
    ...
    for (final key in keys) {
      if (key.contains('footwear') || key.contains('shoe') || key.contains('sneaker')) {
        return 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&q=80';
      }
      if (key.contains('sport') || key.contains('outdoor') || key.contains('fitness') || key.contains('active')) {
        return 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=400&q=80';
      }
      if (key.contains('access') || key.contains('jewel') || key.contains('watch')) {
      ...
      if (key.contains('cloth') || key.contains('apparel') || key.contains('fashion')) {
        return 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=400&q=80';
      }
      if (key.contains('elect') || key.contains('gadget') || key.contains('audio')) {
    ...
    final seed = (slug ?? title ?? 'category').hashCode.abs() % categoryFallbacks.length;
...
String formatImageUrl(
  ...
  if (enableVercelFallback) {
    final isVercelStorage =
        formattedUrl.contains('e-commers-laravel.vercel.app/storage/');
